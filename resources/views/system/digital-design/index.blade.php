        ...
        <tr>
            ...
            <td>
                @if($item->banner_image)
                    <img src="{{ asset('uploads/digital-design/banner/' . $item->banner_image) }}" alt="Banner Image" class="img-fluid" style="max-width: 100px; max-height: 100px;">
                @else
            ...
            <td>{{ $item->position }}</td>
            <td>
                @include('system.partials.digital-design-status')
            </td>
            <td>
                @include('system.partials.editButton')
                @include('system.partials.deleteButton')
                @include('system.partials.digital-design-image')
            </td>
        </tr>
    @endforeach
@endsection
